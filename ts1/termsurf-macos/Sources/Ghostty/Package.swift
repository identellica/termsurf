...
// Note: ghostty_surface_t is a pointer type that already conforms to Sendable in Swift's stdlib
...
extension Notification.Name {
  ...
  static let ghosttyColorDidChange = Notification.Name(
    "com.mitchellh.ghostty.ghosttyColorDidChange")
  ...
  static let ghosttyCloseTabsOnTheRight = Notification.Name(
    "com.mitchellh.ghostty.closeTabsOnTheRight")
  ...
  static let ghosttyCommandPaletteDidToggle = Notification.Name(
    "com.mitchellh.ghostty.commandPaletteDidToggle")
  ...
  static let ghosttyDidUpdateScrollbar = Notification.Name(
    "com.mitchellh.ghostty.didUpdateScrollbar")
...
extension Ghostty.Notification {
  ...
  /// Notification
  static let didReceiveInitialWindowFrame = Notification.Name(
    "com.mitchellh.ghostty.didReceiveInitialWindowFrame")
  static let FrameKey = "com.mitchellh.ghostty.frame"

  /// Notification to render the inspector for a surface
  static let inspectorNeedsDisplay = Notification.Name(
    "com.mitchellh.ghostty.inspectorNeedsDisplay")
  ...
  static let didUpdateRendererHealth = Notification.Name(
    "com.mitchellh.ghostty.didUpdateRendererHealth")

  /// Notifications related to key sequences
  static let didContinueKeySequence = Notification.Name(
    "com.mitchellh.ghostty.didContinueKeySequence")
